...
public class ProfessorDAO {
	...
	public Professor getById(Integer integer) {
		...
		Professor professor = (Professor) session.get(Professor.class, integer);
...
//		Professor professor = (Professor) session.load(Professor.class, id);
	...
	public Professor getByName(String nome) {
		Session session = HibernateUtil.getSessionFactory().openSession();
		// Usando get() para ler a professor com o ID especificado
		Professor professor = (Professor) session.get(Professor.class, nome);
